$(document).ready(function() {
	...
	var rptDocuments = ["/elections/Topic Stats.rptdocument",
						"/elections/Topic Breakdown.rptdocument"];
	var bookmarks = ["topicStats", "TopicBreakdown"];
	var heights = [300, 350]
	var widths = [775, 980];
	...
	function myInit()  {
        try {
            ...
            viewer = [new actuate.Viewer("topicStats"),
